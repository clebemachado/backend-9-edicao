package br.com.dbc.vemserdbc.escola.repositorys;

import br.com.dbc.vemserdbc.escola.codecs.AlunoCodec;
...
public class AlunoRepository {
    ...
    private final String DATABASE = "vemserdbc";
    private final String COLLECTION_ALUNOS = "alunos_java_web";
    ...
    private void criarConexao() {
        ...
        this.cliente = new MongoClient(new ServerAddress("localhost", 27017), credential, opcoes);
        this.bancaDeDados = cliente.getDatabase(DATABASE);
    ...
    public void salvar(Aluno aluno) {
        ...
        criarConexao();
        MongoCollection<Aluno> alunos = this.bancaDeDados.getCollection(COLLECTION_ALUNOS, Aluno.class);
        if (aluno.getId() == null) {
    ...
    public List<Aluno> pesquisarPor(String nome) {
        criarConexao();
        MongoCollection<Aluno> alunoCollection = this.bancaDeDados.getCollection(COLLECTION_ALUNOS, Aluno.class);
